...
import { SOBER_DIAGRAM_FRAMES, SOBER_MIX_FRAMES, SOBER_TERMINAL_FRAMES, SoberDiagram, SoberMix, SoberTerminal } from "./Sober";
...
export const Root: React.FC = () => (
  <>
    ...
    <Composition id="Clear" component={Clear} durationInFrames={CLEAR_FRAMES} fps={30} width={1920} height={1080} />
